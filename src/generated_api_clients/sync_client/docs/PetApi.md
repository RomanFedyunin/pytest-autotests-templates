# petstore-sync-api-client.PetApi
...
from petstore-sync-api-client.models.pet import Pet
...
with petstore-sync-api-client.ApiClient(configuration) as api_client:
    ...
    api_instance = petstore-sync-api-client.PetApi(api_client)
    pet = petstore-sync-api-client.Pet() # Pet | Create a new pet in the store
...
with petstore-sync-api-client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore-sync-api-client.PetApi(api_client)
    pet = petstore-sync-api-client.Pet() # Pet | Update an existent pet in the store
...
```python
import petstore-sync-api-client
from petstore-sync-api-client.models.api_response import ApiResponse
from petstore-sync-api-client.rest import ApiException
from pprint import pprint
